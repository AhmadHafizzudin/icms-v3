...
<div class="container">
	<div class="navbar-header">
		...
		<!-- Your Logo -->
		<a href="#hero" class="navbar-brand">INTEGRATED CAMPUS <br><span class="lighter">MANAGEMENT SYSTEM</span></a>
	</div>
	<!-- Start Navigation -->
...
<!-- Gallery
	================================================== -->
<section id="gallery" class="parallax section" style="background-image: url(http://themepush.com/demo/runcharity/frontpage/img/2.jpg);">
		...
		<div class="row">
			...
			<div class="col-md-4">
				<a href="images/1/img1.jpg?fit=crop&amp;fm=jpg&amp;h=700&amp;q=75&amp;w=1050" title="This is the description">
					<img src="images/1/img2.jpg?fit=crop&amp;fm=jpg&amp;h=700&amp;q=75&amp;w=1050" alt="" class="image-responsive">
				            ...
				            <div class="login-content">
				                ...
				                <div class="login-form">
				                    <form>
				                       ...
				                       <a href='{{asset("admin.home")}}' target="_blank"> Log masuk </a>
				                        <div class="checkbox">
				                            <label>
